package com.jgarzon.clients.config;
...
public class LoggingConfiguration {
    ...
    private void addLogstashTcpSocketAppender(LoggerContext context) {
        ...
        logstashAppender.addDestinations(new InetSocketAddress(this.jHipsterProperties.getLogging().getLogstash().getHost(),
    ...
    private String customFields() {
        return "{" + "\"app_name\":\"" + this.appName + "\"" + "," + "\"app_port\":\"" + this.serverPort + "\"" + "}";
    }
    ...
    /**
     * Logback configuration is achieved by configuration file and API. When configuration file change is detected, the configuration is reset. This
     * listener ensures that the programmatic configuration is also re-applied after reset.
     */
